    ...
    function (r, p, w) {
      ...
      function e(b) {
        switch (b) {
          ...
          case 38: // Transgender
            return Ib(
              "#ffffff #ff90ea #37f3ff #ff90ea #ffffff".split(" ")[
                Math.floor((Date.now() / 2000) % 5)
              ],
              "#ff90ea #37f3ff #ff90ea #ffffff #ff90ea".split(" ")[
                Math.floor((Date.now() / 2000) % 5)
              ],
              (Date.now() / 2000) % 1
            );
          case 39: // Flashing Red
            return Ib(
              "#000000 #ff0000".split(" ")[Math.floor((Date.now() / 1000) % 2)],
              "#ff0000 #000000".split(" ")[Math.floor((Date.now() / 1000) % 2)],
              (Date.now() / 2000) % 1
            );
          case 40: // Monochrome
            return Ib(
              "#000000 #ffffff".split(" ")[Math.floor((Date.now() / 100) % 2)],
              "#ffffff #000000".split(" ")[Math.floor((Date.now() / 100) % 2)],
              (Date.now() / 100) % 1
            );
          case 41:
            return "#ff0000";
          ...
          case 47: //Eclipse
            return Ib(
              "#000000 #ff9000 #ffffff #000000 #226ef6 #ffffff".split(" ")[
                Math.floor((Date.now() / 200) % 6)
              ],
              "#ff9000 #ffffff #000000 #226ef6 #ffffff #000000".split(" ")[
                Math.floor((Date.now() / 200) % 6)
              ],
              (Date.now() / 200) % 1
            );
          case 48: //Duo-Chromatic
            return Ib(
              "#ff1000 #ff9000 #ffd300 #000000 #00e00b #226ef6 #a913cf #ffffff".split(
                " "
              )[Math.floor((Date.now() / 160) % 8)],
              "#ff9000 #ffd300 #000000 #00e00b #226ef6 #a913cf #ffffff #ff1000".split(
                " "
              )[Math.floor((Date.now() / 160) % 8)],
              (Date.now() / 160) % 1
            );
          case 49: //Solar Eclipse
            return Ib(
              "#000000 #ff9000 #000000 #ffffff #ff9000 #ffffff".split(" ")[
                Math.floor((Date.now() / 200) % 6)
              ],
              "#ff9000 #000000 #ffffff #ff9000 #ffffff #000000".split(" ")[
                Math.floor((Date.now() / 200) % 6)
              ],
              (Date.now() / 200) % 1
            );
          case 50: //Lunar Eclipse
            return Ib(
              "#000000 #226ef6 #000000 #ffffff #226ef6 #ffffff".split(" ")[
                Math.floor((Date.now() / 200) % 6)
              ],
              "#226ef6 #000000 #ffffff #226ef6 #ffffff #000000".split(" ")[
                Math.floor((Date.now() / 200) % 6)
              ],
              (Date.now() / 200) % 1
            );
          case 51: //Woomy pastel green
            return "#8bfe6a";
          // Rainbow colors
          case 100:
            return "#FF0000";
      ...
      function D(b, n = M[b].color) {
        ...
        return {
          ...
          tiggle: 0,
          layer: c.layer,
          mirrorMasterAngle: c.mirrorMasterAngle ?? false,
          guns: {
            ...
            return {
              place: (b, ...c) => {
                if (b >= d.length)
                  throw (
                    (console.error(b, d),
                    Error("Trying to reference a clickable out of a region!"))
                  );
                d[b].set(...c);
              },
              hide: () => {
        ...
        A = {
          getStatNames: (b) => {
            switch (b) {
              ...
              case 7:
                return "Body Damage;Max Health;Ball Speed;Ball Longevity;Ball Penetration;Ball Sharpness;Ball Density;Movement Speed;Shield Regeneration;Shield Capacity".split(
                  ";"
                );
              case 8:
                return "Body Damage;Max Health;Lance Range;Lance Longevity;Lance Penetration;Lance Sharpness;Lance Density;Movement Speed;Shield Regeneration;Shield Capacity".split(
                  ";"
                );
              default:
            ...
            return {
              ...
              gui: () => {
                ...
                n &&
                  ...
                  (A.skills[0].amount = (n / 32 ** 9) & 31),
                  (A.skills[1].amount = (n / 32 ** 8) & 31),
                  (A.skills[2].amount = (n / 32 ** 7) & 31),
                  (A.skills[3].amount = (n / 32 ** 6) & 31),
                  (A.skills[4].amount = (n / 32 ** 5) & 31),
                  (A.skills[5].amount = (n / 0x100000) & 31),
                  (A.skills[6].amount = (n / 0x8000) & 31),
                  (A.skills[7].amount = (n / 0x400) & 31),
                  (A.skills[8].amount = (n / 0x20) & 31),
                  (A.skills[9].amount = (n / 0x1) & 31));
                k && (A.accel = a.next());
                x &&
                  ((A.party = a.next()),
          ...
          return (c) => {
            ...
            if (!b.hideGui) {
              ...
              }
              {
                ...
                g.lineWidth = 4;
                if (z.key == "notokenforyoutotokenbeggar") {
                  // draw it ecliptic
                  N.draw(
                    z.name,
        ...
        Ta = (() => {
          ...
          let x = () => {
              let a = [
                ...
                Math.round(b.finalKills[0].get() + b.finalKills[1].get()),
              ];
              ...
              a[2] && c.push(a[3] + " total killstreak");
              return d + c.join(" and ");
            },
            q = () =>
      ...
      const e = {
        ...
        servers: [
          ...
          },
          {
            id: "a",
            type: "0unk",
            code: "4tdm-richardsonsarras",
            at: p.glitch("richardsons-arras-source"), //Server Here!
          },
        ]
          .map((a, e) => ({
            data: a,
